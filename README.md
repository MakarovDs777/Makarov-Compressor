...
Ну и соответственно по этим трем числам я могу обратно создать этот массив чисел по которому я могу обратно превратить в тот же самый текст через CodePen...

[![myplot.png](https://i.postimg.cc/PqcXkPbk/myplot.png)](https://postimg.cc/ns4b4Vwd)

Можно впринципе и оптимизировать код с помощью стека FIFO, LIFO... Прогружать последовательность быстрее предыдущие числа удалять последущие прогружать...
