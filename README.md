...
Ну и как продолжение к предыдушей мысли так вот если подразумевает исходный код как некоторое паранормальное явление, и точку сборки в этом паранормальном явлении исходного кода то по сути можно даже миллиарлы строчек исходного кода прогрузить как нечто одно целое!
