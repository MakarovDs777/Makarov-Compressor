...
Так вот как продолжение к предыдущей мысли если подразумевать исходный код как некоторое паранормальное явление, и точку сборки в этом паранормальном явлении исходного кода описав достаточно точно образ этого парнормального явления то по сути можно даже миллиарды строчек исходного кода прогрузить как нечто одно целое!
