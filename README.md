...
У нас есть массив с символами и массив с масивами всех индексов всех символов массива символов, и превращая это в один массив мы можем получить последовательность чисел которую с помощью кода CodePen мы будем прогружать частями превращая и запуская текст исходного кода в исходный код, и дальше добавить ещё третий флаг "условное число" которое будет расположенно между исходными кодами текстов ну пускай это будет число увеличное на 2 от максимального числа в едином массиве чисел после чего предущий текст исходный код последовательности чисел удалять, и таким образом можно прогрузить всё что угодно!
